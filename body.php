<div name = "BLOGSECTION">
            <div class="container">
                <div class="row">
                        <div class="section-heading text-center">
                                <div class="col-md-12 col-xs-12" id="title">
                                    <h1 id="topline">OUR AVAILABLE
                    
                                        <h1 id="secondline"> COURSES & ACTIVITIES </h1>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination pagination-lg justify-content-right">
            <li class="page-item">
